...
#include "NumberPoints.h"
#include "MooseUtils.h"

registerMooseObject("PhaseFieldApp", NumberPoints);

InputParameters
NumberPoints::validParams()
{
...
NumberPoints::NumberPoints(const InputParameters & parameters)
